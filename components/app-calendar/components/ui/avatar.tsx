...
const AvatarRoot = forwardRef<TAvatarRootRef, TAvatarRootProps>(
  ({ className, ...props }, ref) => (
...
const AvatarImage = forwardRef<TAvatarImageRef, TAvatarImageProps>(
  ({ className, ...props }, ref) => (
...
type TAvatarFallbackProps = ComponentPropsWithoutRef<
  typeof AvatarPrimitive.Fallback
> & {
  type?: "default" | "icon";
};

const AvatarFallback = forwardRef<TAvatarFallbackRef, TAvatarFallbackProps>(
  ({ className, type = "default", children, ...props }, ref) => (
    ...
    >
      {type === "default" ? (
        <p className="absolute left-1/2 top-1/2 w-fit -translate-x-1/2 -translate-y-1/2">
          {children}
        </p>
      ) : (
