...
type TScrollBarProps = ComponentPropsWithoutRef<
  typeof ScrollAreaPrimitive.ScrollAreaScrollbar
>;

const ScrollBar = forwardRef<TScrollBarRef, TScrollBarProps>(
  ({ className, orientation = "vertical", ...props }, ref) => (
    ...
    >
      <ScrollAreaPrimitive.ScrollAreaThumb
        className={cn(
          "relative flex-1 rounded-full bg-gray-400 dark:bg-gray-500",
        )}
      />
    </ScrollAreaPrimitive.ScrollAreaScrollbar>
  ),
...
type TScrollAreaProps = ComponentPropsWithoutRef<
...
const ScrollArea = forwardRef<TScrollAreaRef, TScrollAreaProps>(
  (
    { className, children, viewportRef, orientation = "vertical", ...props },
    ref,
  ) => (
