...
import { cn } from "@/components/app-calendar/utils/helpers/cn.helper";
...
type TSelectTriggerProps = ComponentPropsWithoutRef<
  typeof SelectPrimitive.Trigger
>;

const SelectTrigger = forwardRef<TSelectTriggerRef, TSelectTriggerProps>(
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <div className="ml-2">
          ...
          <Info
            className="hidden size-4 text-error-600 group-data-[invalid=true]:flex"
            aria-hidden="true"
          />
        </div>
...
type TSelectScrollUpButtonRef = ElementRef<
  typeof SelectPrimitive.ScrollUpButton
>;
type TSelectScrollUpButtonProps = ComponentPropsWithoutRef<
  typeof SelectPrimitive.ScrollUpButton
>;
...
type TSelectScrollDownButtonRef = ElementRef<
  typeof SelectPrimitive.ScrollDownButton
>;
type TSelectScrollDownButtonProps = ComponentPropsWithoutRef<
  typeof SelectPrimitive.ScrollDownButton
>;
...
type TSelectContentProps = Omit<
  ComponentPropsWithoutRef<typeof SelectPrimitive.Content>,
  "position"
> & { viewportClassName?: string };

const SelectContent = forwardRef<TSelectContentRef, TSelectContentProps>(
    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            "h-[var(--radix-select-trigger-height)] w-[var(--radix-select-trigger-width)] p-1",
            viewportClassName,
          )}
        >
          {children}
...
const SelectLabel = forwardRef<TSelectLabelRef, TSelectLabelProps>(
  ({ className, ...props }, ref) => (
...
const SelectGroup = forwardRef<TSelectGroupRef, TSelectGroupProps>(
  ({ className, ...props }, ref) => (
...
type TSelectItemProps = ComponentPropsWithoutRef<
  typeof SelectPrimitive.Item
> & { indicatorPosition?: "left" | "right" };

const SelectItem = forwardRef<TSelectItemRef, TSelectItemProps>(
  ({ className, children, indicatorPosition = "right", ...props }, ref) => (
...
type TSelectSeparatorProps = ComponentPropsWithoutRef<
  typeof SelectPrimitive.Separator
>;

const SelectSeparator = forwardRef<TSelectSeparatorRef, TSelectSeparatorProps>(
  ({ className, ...props }, ref) => (
    <SelectPrimitive.Separator
      ref={ref}
      className={cn("-mx-1 my-1 h-px bg-b-secondary", className)}
      {...props}
    />
  ),
);
