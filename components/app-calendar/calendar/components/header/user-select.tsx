...
import { Avatar } from "@/components/app-calendar/components/ui/avatar";
import { Select } from "@/components/app-calendar/components/ui/select";
import { AvatarGroup } from "@/components/app-calendar/components/ui/avatar-group";
              ...
              {users.map((user) => (
                <Avatar.Root key={user.id} className="size-6 text-xxs">
                  <Avatar.Image
                    ...
                    alt={user.name}
                  />
                  <Avatar.Fallback className="text-xxs">
                    {user.name[0]}
                  </Avatar.Fallback>
                </Avatar.Root>
              ))}
