  ...
  "flex select-none flex-col gap-0.5 truncate whitespace-nowrap rounded-md border px-2 py-1.5 text-xs focus-visible:outline-offset-2",
  {
    variants: {
      color: {
        ...
        // Dot variants
        "blue-dot":
          "border-b-muted bg-secondary text-t-primary [&_.event-dot]:fill-blue-600",
        "green-dot":
          "border-b-muted bg-secondary text-t-primary [&_.event-dot]:fill-green-600",
        "red-dot":
          "border-b-muted bg-secondary text-t-primary [&_.event-dot]:fill-red-600",
        "orange-dot":
          "border-b-muted bg-secondary text-t-primary [&_.event-dot]:fill-orange-600",
        "purple-dot":
          "border-b-muted bg-secondary text-t-primary [&_.event-dot]:fill-purple-600",
        "yellow-dot":
          "border-b-muted bg-secondary text-t-primary [&_.event-dot]:fill-yellow-600",
      },
    },
    defaultVariants: {
      color: "blue-dot",
